		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App",
									"targetURL": "#namespacefiorifioriapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"namespacefiorifioriapp-display": {
								"semanticObject": "namespacefiorifioriapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=namespacefiori.fioriapp",
									"url": sap.ui.require.toUrl("namespacefiori/fioriapp")
								}
							}
						}
					}
